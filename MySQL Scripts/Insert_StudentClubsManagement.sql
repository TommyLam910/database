...
-- Insert value for Student_Clubs_Member
...
-- INSERT INTO Student_Clubs_Member VALUES (231022786, 'Sam', 'Tang', 'M'); unable to insert as duplicate PK for the same student ID
-- INSERT INTO Student_Clubs_Member VALUES (231022777, null, null, 'M'); unable to insert as first name and last name cannot be null
-- INSERT INTO Student_Clubs_Member VALUES (231022777, 'Sam', 'Tang', 'K');  unable to insert as gender can only be F / M / O / N
 
-- Insert value for Member_Phone
INSERT INTO Member_Phone VALUES (370528133, 2041220979);
INSERT INTO Member_Phone VALUES (370528133, 4071330318);
...
-- INSERT INTO Member_Phone VALUES (370528133, 2041220979); unable to insert the same value as it is composite primary key 

-- Insert value for Alumnus
...
-- INSERT INTO Alumnus VALUES (231022786, null); unable to insert as Graduation_Date cannot be null

-- Insert value for Company
...
-- INSERT INTO Company VALUES (65716936247, null ); unable to insert as company name cannot be null
-- INSERT INTO Company VALUES (1234567891011, 'Rove' ); able to insert 1234567891011 as company ID, but the value will become 99999999999 as can only be 11 numberic 

-- Insert value for Department
...
-- INSERT INTO Department VALUES (007, null); unable to insert as department name cannot be null

-- Insert value for Department belongs to Company
...
-- INSERT INTO Department_BelongsTo_Company VALUES (65716936247, 006); unable to insert the same value as it is composite primary key 
-- INSERT INTO Department_BelongsTo_Company VALUES (12345678910, 001); unable to insert the as company ID 12345678910 is not exit in company table

-- Insert value for Alumnus_WorksFor_Company 
...
-- INSERT INTO Alumnus_WorksFor_Company VALUES (231022786, 14461959389, 007, 'Supply Chain Analyst', '2018-06-25', '2021-09-15'); unable to insert as Company 14461959389 does not have department 007
-- INSERT INTO Alumnus_WorksFor_Company VALUES (123456789, 14461959389, 006, 'Supply Chain Analyst', '2018-06-25', '2021-09-15'); unable to insert as member 123456789 is not in Alumnus table
-- INSERT INTO Alumnus_WorksFor_Company VALUES (231022786, 14461959389, 006, null, '2018-06-25', '2021-09-15'); unable to insert as position name cannot be null
-- INSERT INTO Alumnus_WorksFor_Company VALUES (231022786, 14461959389, 006, 'Supply Chain Analyst', null, '2021-09-15'); unable to insert as Hire_date is primary key, which cannot be null
...
INSERT INTO Alumnus_WorksFor_Company VALUES (231022786, 65716936247, 004, 'Data Analyst', '2021-10-01', NULL);
-- INSERT INTO Alumnus_WorksFor_Company VALUES (231022786, 65716936247, 004, null, '2021-10-01', NULL); unable to insert as position name cannot be null
-- INSERT INTO Alumnus_WorksFor_Company VALUES (231022786, 65716936247, 007, 'Data Analyst', '2021-10-01', NULL); unable to insert as there is no depatment number as 007
-- INSERT INTO Alumnus_WorksFor_Company VALUES (231022786, 65716936247, 004, 'Data Analyst', null, NULL); unable to insert as hire date cannot be null

-- Insert value for Current_student
...
-- INSERT INTO Current_Student VALUES (312399660, null, '2017-12-18'); unable to insert as Faculty cannot be null
-- INSERT INTO Current_Student VALUES (123456789, 'Finance ', '2017-12-18'); unable to insert as student ID 123456789 is not exit in the Student_Clubs_Member table
-- INSERT INTO Current_Student VALUES (312399699, 'Accounting', null); unable to insert as Enrollment_date cannot be null

-- Insert value for instructor
...
-- INSERT INTO Instructor VALUES (250134632, null, 'Lam'); -- unable to insert as First_name cannot be null
-- INSERT INTO Instructor VALUES (250134632, 'Tony', null); -- unable to insert as Last_name cannot be null
-- INSERT INTO Instructor VALUES (250134632, 'Bob', 'Lam' ); -- unable to insert as duplicate instructor ID

-- Insert value for Student_Club
INSERT INTO Student_Club VALUES ('C01', 'Basketball', 382109009, 325496257);
INSERT INTO Student_Club VALUES ('C02', 'Tennis', 329627458, 380825823);
INSERT INTO Student_Club VALUES ('C03', 'Baseball', 366144914, 313370173);
INSERT INTO Student_Club VALUES ('C04', 'Badminton', 273292515, 250134632);
INSERT INTO Student_Club VALUES ('C05', 'Volleyball', 306385559, 313370173);
INSERT INTO Student_Club VALUES ('C06', 'Swimming', 370528133, 262322922);
INSERT INTO Student_Club VALUES ('C07', 'Boxing', 231022786, null);
-- INSERT INTO Student_Club VALUES ('K06', 'Swimming', 370528133, 262322922); unable to insert, club ID has to start with C 
-- INSERT INTO Student_Club VALUES ('C066', 'Swimming', 370528133, 262322922); unable to insert, club ID can only be C__ 
-- INSERT INTO Student_Club VALUES ('C09', 'Swimming', 123456789, 262322922); unable to insert as student ID 123456789 is not exit in the Student_Clubs_Member table
-- INSERT INTO Student_Club VALUES ('C07', 'Boxing', 231022786, 262322922); unable to insert as duplicate clud ID
-- INSERT INTO Student_Club VALUES ('C08', 'Swimming', 370528133, 123456789); unable to insert as instructor ID 123456789 is not exit in the Instructor table

-- Insert value for Group_BelongsTo_Club
...
-- INSERT INTO Groups_BelongsTo_Club VALUES ('C01', 'G01', 231022786, '2022-01-01', null); Unable to insert as C01 and G01 are already exits
-- INSERT INTO Groups_BelongsTo_Club VALUES ('C01', 'G01', 329627458,'2019-12-31', '2018-01-04'); unable to insert as end date is bigger than Establishment_Date
-- INSERT INTO Groups_BelongsTo_Club VALUES ('C07', 'G14', 231022786, null, null); unable to insert as Establishment_Date cannot be null

-- Insert value for Event_Detail
...
-- INSERT INTO Event_Detail VALUES ('E14', 'Sporty Workshop', 'W', 1, 01, 0, '2021-06-20', '18:00'); unable to insert as E14 already exit
-- INSERT INTO Event_Detail VALUES ('E15', 'Sporty Workshop', 'K', 1, 01, 0, '2021-06-20', '18:00'); unable to insert as Building_Number can only be S / W/ S / N
-- INSERT INTO Event_Detail VALUES ('C15', 'Sporty Workshop', 'W', 1, 01, 0, '2021-06-20', '18:00'); unable to insert as event ID should be E__

-- Insert value for Group_Organizes_Event
...
INSERT INTO Group_Organizes_Event VALUES('C01', 'G01', 'E10', 382109009);
...
-- INSERT INTO Group_Organizes_Event VALUES( 'C02', 'G02','E02', 329627458); unable to insert again as is duplicate values
-- INSERT INTO Group_Organizes_Event VALUES( 'C02', 'G02','E02', 123456789); unable to insert as there is no student ID as 123456789

-- Insert value for Member_Join_Group
...
-- INSERT INTO Member_Join_Group VALUES (312399660, 'C02', 'G09', '2019-01-04', null); unable to insert as is duplicate
-- INSERT INTO Member_Join_Group VALUES (312399660, 'C02', 'G09', '2018-01-04', '2017-12-11'); unable to insert as End_date cannot be earlier than Start_Date based on the constraint
-- INSERT INTO Member_Join_Group VALUES (312399660, 'C02', 'G30', '2018-01-04', null); unable to insert as G30 is not belongs to C02 in the Groups_BelongsTo_Club table
-- INSERT INTO Member_Join_Group VALUES (123456789, 'C02', 'G09', '2018-01-04', null); unable to insert as student 123456789 is not exit in the member table

-- Insert value for Member_PaidBy_Group
...
-- INSERT INTO Member_PaidBy_Group VALUES (123456789, 'C05', 'G12', 400, '2019-08-31'); unable to insert as student 123456789 is not belongs to the C05 club and G12 group
-- INSERT INTO Member_PaidBy_Group VALUES (208564055, 'C05', 'G30', 400, '2019-08-31'); unable to insert as C05 club doesn't have G30 included
-- INSERT INTO Member_PaidBy_Group VALUES (208564055, 'C05', 'G05', null, null); unable to insert as fund and date cannot be null

-- Insert value for Funded_Project
...
-- INSERT INTO Funded_Project VALUES ('P12', 'Sports Buzz2', 2488); unable to inseart as duplicate Project ID
-- INSERT INTO Funded_Project VALUES ('C12', 'Sports Buzz2', 2488); unable to inseart as Project ID has to be P__
-- INSERT INTO Funded_Project VALUES ('P13', null, null); unable to inseart as Project_Name and fund cannot be null

-- Insert value for Group_WorkOn_FundedProject
...
INSERT INTO Group_WorkOn_FundedProject VALUES ('C03', 'G03', 'P03', '2017-10-17', '2017-12-01');
...
-- INSERT INTO Group_WorkOn_FundedProject VALUES ('C06', 'G13', 'P14', '2017-10-17', '2017-12-01'); unable to insert as there is no project ID as P14
-- INSERT INTO Group_WorkOn_FundedProject VALUES ('C06', 'G06', 'P12', null, null); unable to insert as Start_Date cannot be null
