...
<body>
    ...
    try {
        $sql = "SELECT EventID, Event_Subject, Building_Number, Building_Floor, Room_Number, RegistrationFee, Event_Date, Event_Time FROM Event_Detail WHERE RegistrationFee = '$_POST[registrationFee]'";
